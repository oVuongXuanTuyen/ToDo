...
class CalendarViewController: BaseViewController {
    ...
    override func setDefaults() {
        ...
        let dates = [
            dateFormater.date(from: "01/03/2018"),
            dateFormater.date(from: "04/03/2018"),
            dateFormater.date(from: "08/03/2018"),
            dateFormater.date(from: "09/03/2018"),
            dateFormater.date(from: "20/03/2018"),
            dateFormater.date(from: "28/03/2018"),
            dateFormater.date(from: "30/03/2018")
        ]
        for date in dates {
